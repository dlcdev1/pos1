...
import (
	"acution_dlcdev/configuration/database/mongodb"
	"acution_dlcdev/internal/infra/api/web/controller/auction_controller"
	"acution_dlcdev/internal/infra/api/web/controller/bid_controller"
	"acution_dlcdev/internal/infra/api/web/controller/user_controller"
	"acution_dlcdev/internal/infra/database/auction"
	"acution_dlcdev/internal/infra/database/bid"
	...
	"acution_dlcdev/internal/usecase/user_usecase"
	"context"
